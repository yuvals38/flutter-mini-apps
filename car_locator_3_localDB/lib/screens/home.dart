        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                appState.createCustomRoute = true;
            ...
            ListTile(
              title: Text('Clear routes'),
              trailing: Icon(Icons.delete_forever),
              onTap: () {
                appState.createCustomRoute = false;
                appState.clearRoutes();
                // Update the state of the app
                // ...
                // Then close the drawer
                Navigator.pop(context);
              ...
              color: Colors.blueAccent,
                size: 50.0,
                  ...
                  Visibility(
                    ...
                    child: Text("Getting current location", style: TextStyle(color: Colors.grey, fontSize: 18),),
                  )
                ],
              )
            )
